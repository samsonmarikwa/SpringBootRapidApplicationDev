package com.samsonmarikwa.thymeleaf.controller;

import com.samsonmarikwa.thymeleaf.domain.Post;
...
public class PostController {
   ...
   private List<Post> createPosts() {
      // Post 1
      Post post1 = new Post("My Blog Post 1", getPostBody(), new Date(), "Sam Marikwa");
      Post post2 = new Post("My Blog Post 2", "<p>This post didn't take long to write.", new Date(), "Annet Marikwa");
